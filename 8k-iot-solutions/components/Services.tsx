            ...
            {isLoading ? (
                ...
                <div className="grid grid-cols-2 gap-6 md:gap-8 items-stretch">
                  ...
                  >
                      ...
                      <div className="relative bg-zinc-50/50 border-b border-zinc-100 px-4 sm:px-8 pt-6 sm:pt-8 pb-6 sm:pb-8 overflow-hidden h-auto sm:h-[210px] flex flex-col">
                      ...
                      <div className="relative z-10 flex-1 flex flex-col">
                          ...
                          <h3 className="text-base sm:text-xl font-poppins font-semibold text-zinc-900 leading-tight">Hardware Services</h3>
                          </div>
                          
                          {/* Descriptive Subtitle for better text hierarchy */}
                          <p className="text-xs sm:text-sm text-zinc-500 font-medium mb-4 sm:mb-6 line-clamp-2">
                          ...
                          <span className="text-xs sm:text-sm font-semibold text-zinc-400">PHP</span>
                          <span className="text-2xl sm:text-5xl font-poppins font-bold tracking-tighter text-zinc-900 leading-none">2,000</span>
                          <span className="text-xs sm:text-sm font-medium text-zinc-500 sm:ml-1">/project</span>
                          </div>
                      </div>
                      </div>
          
                      {/* --- BODY BLOCK (Features & CTA) --- */}
                      <div className="p-4 sm:p-8 flex flex-col flex-1 bg-white relative z-10">
                      <ul className="space-y-3 sm:space-y-4 flex-1 mb-6 sm:mb-8">
                          {HARDWARE_FEATURES.map((feature, i) => (
                          <li key={i} className="flex items-start gap-2 sm:gap-3">
                              <Check className="w-4 h-4 sm:w-5 sm:h-5 text-zinc-400 shrink-0 mt-0.5 sm:mt-0.5" strokeWidth={2.5} />
                              <span className="text-xs sm:text-sm text-zinc-700 font-medium leading-snug">{feature}</span>
                          </li>
                          ))}
                      </ul>
                      ...
                      <Link 
                          ...
                          className="block text-center w-full bg-white border border-zinc-200 text-zinc-800 font-semibold text-xs sm:text-sm py-2.5 sm:py-3.5 rounded-xl hover:bg-zinc-50 hover:border-zinc-300 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 shadow-sm"
                      >
                          Explore Hardware
                      </Link>
                      </div>
                  ...
                  >
                      {/* --- HEADER BLOCK (Contains Pattern & Pricing) --- */}
                      <div className="relative bg-gradient-to-b from-indigo-50/80 to-white border-b border-indigo-50/80 px-4 sm:px-8 pt-6 sm:pt-8 pb-6 sm:pb-8 overflow-hidden h-auto sm:h-[210px] flex flex-col">
                      ...
                      <div className="relative z-10 flex-1 flex flex-col">
                          <div className="flex justify-between items-start mb-2">
                          <h3 className="text-base sm:text-xl font-poppins font-semibold text-zinc-900 leading-tight">Software Services</h3>
                          </div>
                          ...
                          {/* Pricing Block Highlight */}
                          <div className="flex items-baseline gap-1 mt-auto flex-wrap">
                          <span className="text-xs sm:text-sm font-semibold text-indigo-400">PHP</span>
                          <span className="text-2xl sm:text-5xl font-poppins font-bold tracking-tighter text-indigo-950 leading-none">2,000</span>
                          <span className="text-xs sm:text-sm font-medium text-zinc-500 sm:ml-1">/project</span>
                          </div>
                      </div>
                      </div>
                      ...
                      <ul className="space-y-3 sm:space-y-4 flex-1 mb-6 sm:mb-8">
                          ...
                          <li key={i} className="flex items-start gap-2 sm:gap-3">
                              <Check className="w-4 h-4 sm:w-5 sm:h-5 text-indigo-500 shrink-0 mt-0.5 sm:mt-0.5" strokeWidth={2.5} />
                              <span className="text-xs sm:text-sm text-zinc-700 font-medium leading-snug">{feature}</span>
                          </li>
                          ))}
                      </ul>
                      ...
                      <Link 
                          ...
                          className="block text-center w-full bg-indigo-600 text-white font-semibold text-xs sm:text-sm py-2.5 sm:py-3.5 rounded-xl hover:bg-indigo-700 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 shadow-md shadow-indigo-600/20"
                      >
                          Explore Software
                      </Link>
                      </div>
