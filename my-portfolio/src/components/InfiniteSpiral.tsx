...
type SpiralStyle = CSSProperties & {
  ...
  "--infinite-spiral-card-height": string;
  "--infinite-spiral-card-radius": string;
};
...
export default function InfiniteSpiral({
  ...
  const renderLogo = (item: (typeof normalizedItems)[number]) => (
    <Image
  ...
  return (
    ...
    >
      <div
        ...
        role="list"
        aria-label="Client logo gallery"
      >
